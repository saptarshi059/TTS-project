> [!TIP] Some models (e.g. BGE-large) may stall due to XET backend issues. For them, try `source src/utils/hf_env.sh` 

> [!NOTE] ALL sampled datasets and indices can be downloaded from 
