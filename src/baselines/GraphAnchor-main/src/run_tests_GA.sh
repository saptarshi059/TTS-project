...
# Build index
python -u build_index/emb/index.py --dataset 2wikimultihopqa --model bge-base-en-v1.5
python -u build_index/emb/index.py --dataset hotpotqa --model bge-base-en-v1.5
python -u build_index/emb/index.py --dataset musique --model bge-base-en-v1.5
python -u build_index/emb/index.py --dataset frames --model bge-base-en-v1.5
