...
# Build index
python -u build_index/emb/index.py --dataset 2wikimultihopqa --model bge-large-en-v1.5
python -u build_index/emb/index.py --dataset hotpotqa --model bge-large-en-v1.5
python -u build_index/emb/index.py --dataset musique --model bge-large-en-v1.5
python -u build_index/emb/index.py --dataset frames --model bge-large-en-v1.5
